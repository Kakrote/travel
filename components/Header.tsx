      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-amber-500 via-emerald-500 to-teal-500 p-[2px] shadow-md group-hover:scale-105 transition-transform duration-300">
              <div className={`w-full h-full rounded-full flex items-center justify-center transition-colors ${
                isScrolled ? "bg-white text-emerald-600" : "bg-slate-950 text-amber-400"
              }`}>
                <svg
            ...
            <div className="flex flex-col">
              ...
              <span
                className={`text-[10px] tracking-widest font-medium -mt-1 ${
          ...
          <nav className="hidden md:block">
            <div
              className={`flex items-center gap-1 px-4 py-1.5 rounded-full border transition-all duration-300 ${
                isScrolled
              ...
              {homePage.header.nav.map((navItem) => {
                ...
                return (
                  ...
                  >
                    {isActive && (
                      <span
                        className={`absolute inset-0 rounded-full shadow-sm -z-10 transition-all ${
                          isScrolled
